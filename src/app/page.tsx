...
import { LuRadio, LuUser, LuArrowRight, LuMail } from "react-icons/lu";
  ...
  return (
    <main className="mx-auto max-w-[1240px] px-5 py-8 md:py-0">
      <div className="flex min-h-dvh flex-col justify-center gap-16">
        ...
        <div
          // items-stretch estica o itens para ficarem iguais
          className="flex flex-col items-stretch gap-5 md:flex-row"
        >
